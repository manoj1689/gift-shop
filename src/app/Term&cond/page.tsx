  ...
  return (
    <Container>
      ...
      <p>
        ...
        of giftshop's Website, located at www.giftshop.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use giftshop if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing giftshop, you agreed to use
        cookies in agreement with the giftshop's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, giftshop and/or its licensors own the
        intellectual property rights for all material on giftshop. All
        intellectual property rights are reserved. You may access this from
        giftshop for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from giftshop</li>
        <li>Sell, rent or sub-license material from giftshop</li>
        <li>Reproduce, duplicate or copy material from giftshop</li>
        <li>Redistribute content from giftshop</li>
      </ul>
      ...
      <p>
        ...
        giftshop does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of giftshop,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, giftshop shall not be liable
      ...
      <p>
        giftshop reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant giftshop a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of giftshop; and (d) the link is
      ...
      <p>
        ...
        e-mail to giftshop. Please include your name, your organization name,
      ...
      <p>
        No use of giftshop's logo or other artwork will be allowed for linking
